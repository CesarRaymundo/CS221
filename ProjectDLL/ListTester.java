...
public class ListTester {
	...
	private void runTests() {
		...
		testEmptyList(A_iterRemoveAfterNextA_empty,"A_iterRemoveAfterNextA_empty");
		...
		testTwoElementList(A_listIterAddBNewIter_BA, "A_listIterAddBNewIter_BA", LIST_BA, STRING_BA); 
		...
		testThreeElementList(AB_listIterAddCNewIter_CAB, "AB_listIterAddCNewIter_CAB", LIST_CAB, STRING_CAB); 
	...
	////////////////
	/**
	 * Scenario:(#3) emptyList -> addToRear(A) -> [A]
	 *
	...
	/////////////////////
	/**
	 * Scenario:(#5) emptyList -> add(0,A) -> [A]
	 *
	...
	/**
	 * Scenario:(#12) [A] -> removeFirst() -> emptyList
	 * 
	...
	////////////////
	/**
	 * Scenario:(#13) [A] -> removeLast() -> emptyList
	 * 
	...
	////////////////
	/**
	 * Scenario:(#14) [A] -> remove(A) -> emptyList
	 * 
	...
	////////////////
	/**
	 * Scenario:(#15) [A] -> remove(0) -> emptyList
	 * 
	...
	/**
	 * Scenario:(#44) [A] -> iter Remove() after next() returns A -> []
	 *
	 * 
	 * @return[] after iter Remove() after next()
	 */
	private IndexedUnsortedList<Integer> A_iterRemoveAfterNextA_empty() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A();
	...
	private Scenario<Integer> A_iterRemoveAfterNextA_empty = () -> A_iterRemoveAfterNextA_empty();

	////////////////
	/**
	 * Scenario:(#45) [A,B] -> iterRemoveAfterNextA -> [B]
	 *
	 * 
	 * @return[B] after iterRemove() after next()
	 */
	...
	////////////////
	/**
	 * Scenario:(#46) [A,B] -> iterRemoveAfterNextB -> [A]
	 * 
	 * @return [A] after iterRemove() after next()
	 */
	...
	////////////////
	/**
	 * Scenario:(#49) [A,B,C] -> iterRemoveAfterNextC -> [A,B]
	 *
	 * 
	 * @return[A,B] after iterRemove(C)
	 */
	...
	/**
	 * Scenario:(#50) [A] -> List Iterator remove() after next() returns A -> []
	 * 
	 * @return [] after List Iterator remove() after next() returns A
	 */
	...
	///////////////////
	/**
	 * Scenario:(#51) [A,B] -> list iterator remove() after next() returns A -> [B]
	 * 
	 * @return [B] after list iterator remove() after next() returns A
	 */
	...
	///////////////////
	/**
	 * Scenario:(#52) [A,B] -> list iterator remove() after next() returns B -> [A]
	 * 
	 * @return [A] after list iterator remove() after next() returns B
	 */
	...
	///////////////////
	/**
	 * Scenario:(#53) [A,B,C] -> list iterator remove() after next() returns A ->
	 * [B,C]
	 * 
	 * @return [B,C] after list iterator remove() after next() returns A
	 */
	...
	///////////////////
	/**
	 * Scenario:(#54) [A,B,C] -> list iterator remove() after next() returns B ->
	 * [A,C]
	 * 
	 * @return [A,C] after list iterator remove() after next() returns B
	 */
	...
	///////////////////
	/**
	 * Scenario:(#55) [A,B,C] -> list iterator remove() after next() returns C ->
	 * [A,B]
	 * 
	 * @return [A,B] after list iterator remove() after next() returns C
	 */
	...
	///////////////////
	/**
	 * Scenario:(#56) [A] -> list iterator remove() after previous() returns A -> []
	 * 
	 * @return [] after list iterator remove() after previous() returns A
	 */
	...
	///////////////////
	/**
	 * Scenario:(#57) [A,B] -> list iterator remove() after previous() returns A ->
	 * [B]
	 * 
	 * @return [B] after list iterator remove() after previous() returns A
	 */
	...
	///////////////////
	/**
	 * Scenario:(#58) [A,B] -> list iterator remove() after previous() returns B ->
	 * [A]
	 * 
	 * @return [A] after list iterator remove() after previous() returns B
	 */
	...
	///////////////////
	/**
	 * Scenario:(#59) [A,B,C] -> list iterator remove() after previous() returns A
	 * -> [B,C]
	 * 
	 * @return [B,C] after list iterator remove() after previous() returns A
	 */
	...
	///////////////////
	/**
	 * Scenario:(#60) [A,B,C] -> list iterator remove() after previous() returns B
	 * -> [A,C]
	 * 
	 * @return [A,C] list iterator remove() after previous() returns B
	 */
	...
	///////////////////
	/**
	 * Scenario:(#61) [A,B,C] -> list iterator remove() after previous() returns C
	 * -> [A,B]
	 * 
	 * @return [A,B] after list iterator remove() after previous() returns C
	 */
	...
	///////////////////
	/**
	 * Scenario:(#63) [A] -> list iterator add(B) with new iterator -> [B,A]
	 * 
	 * @return [B,A] after list iterator add(B) with new iterator
	 */
	...
	///////////////////
	/**
	 * Scenario:(#64) [A] -> list iterator add(B) after next() returns A -> [A,B]
	 * 
	 * @return [A,B] after list iterator add(B) after next() returns A
	 */
	...
	///////////////////
	/**
	 * Scenario:(#65) [A] -> list iterator add(B) after previous() returns A ->
	 * [B,A]
	 * 
	 * @return [B,A] after list iterator add(B) after previous() returns A
	 */
	...
	///////////////////
	/**
	 * Scenario:(#67) [A,B] -> list iterator add(C) after next() returns A ->
	 * [A,C,B]
	 * 
	 * @return [A,C,B] after list iterator add(C) after next() returns A
	 */
	 ...
	 * 
	 * @return [A,B,C] after iterator add(C) after next() returns B
	 */
	 ...
	 * 
	 * @return [C,A,B] after iterator add(C) after previous() returns A
	 */
	 ...
	 * 
	 * @return [A,C,B] after iterator add(C) after previous() returns B
	 */
	 ...
	 * 
	 * @return [B] after iterator set(B) after previous() returns A
	 */
	 ...
	 * 
	 * @return [A,C] after iterator set(C) after previous() returns B
	 */
	...
	///////////////////
	/**
	 * Scenario:(#80) [A,B,C] -> iterator set(D) after previous() returns A ->
	 * [D,B,C]
	 * 
	...
	///////////////////
	/**
	 * Scenario:(#81) [A,B,C] -> iterator set(D) after previous() returns B ->
	 * [A,D,C]
	 * 
	...
	///////////////////
	/**
	 * Scenario:(#82) [A,B,C] -> iterator set(D) after previous() returns C ->
	 * [A,B,D]
	 * 
	...
	private void testTwoElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			printTest(scenarioName + "_testRemove" + contentsString.charAt(0), testRemoveElement(scenario.build(), contents[0], Result.MatchingValue));
			printTest(scenarioName + "_testRemove" + contentsString.charAt(1), testRemoveElement(scenario.build(), contents[1], Result.MatchingValue));//added
			printTest(scenarioName + "_testRemoveX", testRemoveElement(scenario.build(), ELEMENT_X, Result.NoSuchElement));
			...
			printTest(scenarioName + "_testContains" + contentsString.charAt(0), testContains(scenario.build(), contents[0], Result.True));
			printTest(scenarioName + "_testContains" + contentsString.charAt(1), testContains(scenario.build(), contents[1], Result.True));//added
			printTest(scenarioName + "_testContainsX", testContains(scenario.build(), ELEMENT_X, Result.False));
			...
			//printTest(scenarioName + "_testRemove2", testRemoveIndex(scenario.build(), 2, contents[2], Result.MatchingValue));//changed enum
			printTest(scenarioName + "_testRemove2", testRemoveIndex(scenario.build(), 2, null, Result.IndexOutOfBounds));//added
	...
	private void testThreeElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			// IndexedUnsortedList
						...
						printTest(scenarioName + "_testAddToRear", testAddToRear(scenario.build(), ELEMENT_X, Result.NoException));
						printTest(scenarioName + "_testAddAfter" + contentsString.charAt(0), testAddAfter(scenario.build(), contents[0], ELEMENT_X, Result.NoException));
						printTest(scenarioName + "_testAddAfter" + contentsString.charAt(1), testAddAfter(scenario.build(), contents[1], ELEMENT_X, Result.NoException));//added
						printTest(scenarioName + "_testAddAfterX", testAddAfter(scenario.build(), ELEMENT_X, ELEMENT_Z, Result.NoSuchElement));
						printTest(scenarioName + "_testAddAtIndexNeg1", testAddAtIndex(scenario.build(), -1, ELEMENT_X, Result.IndexOutOfBounds));
						printTest(scenarioName + "_testAddAtIndex0", testAddAtIndex(scenario.build(), 0, ELEMENT_X, Result.NoException));
						printTest(scenarioName + "_testAddAtIndex1", testAddAtIndex(scenario.build(), 1, ELEMENT_X, Result.NoException));
